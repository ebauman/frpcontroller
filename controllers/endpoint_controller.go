...
import (
	"context"
	"fmt"
	"github.com/ebauman/frpcontroller/frpconfig"
	"strings"
	"time"
...
// +kubebuilder:rbac:groups=frp.1eb100.net,resources=endpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=frp.1eb100.net,resources=endpoints/status,verbs=get;update;patch
...
func (r *EndpointReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	err = mgr.GetFieldIndexer().IndexField(
		context.Background(), &corev1.ConfigMap{}, endpointOwnerKey,
	...
	err = mgr.GetFieldIndexer().IndexField(
		context.Background(), &corev1.Pod{}, endpointOwnerKey,
		func(rawObj client.Object) []string {
