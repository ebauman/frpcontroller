...
IMG ?= ebauman/frpcontroller:${RELEASE}
...
# make an release
release: docker-build docker-push release-prepare release-kustomize
...
release-kustomize:
	...
	cd config/rel-${RELEASE} && kustomize edit add label frp.1eb100.net/release:${RELEASE}
